...
SESSION_FTS_FETCH_LIMIT = 4

PROJECT_SCOPED_FETCH_MULTIPLIER = 4
PROJECT_MATCH_BONUS = 0.08
PROJECT_GLOBAL_MISMATCH_PENALTY = 0.03
KEYWORD_HIT_BONUS = 0.12
KEYWORD_SCORE_WEIGHT = 0.05
SESSION_HIT_BONUS = 0.08
SESSION_HIT_SCORE_WEIGHT = 0.04
RRF_K = 60
